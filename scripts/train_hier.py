#!/usr/bin/env python3
"""
TRAINING: FULLY HIERARCHICAL RESNET-18 (OPTION C CONCATENATED HEADS) — v3
==========================================================================
Changes from v2:
...
def main():
    ...
    SAVE_ROOT = "/home/nalwangar/fixed/logs_hierM"
    ...
    print("\n=== TRAINING COMPLETE: HIERARCHICAL RESNET-18 v3 ===")
